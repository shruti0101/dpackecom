        ...
        <div className="w-full mx-auto px-4 md:px-8 pt-6 ">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[90px_1fr_470px_200px] gap-8">
            ...
            <div className="flex xl:flex-col gap-4 ">
              ...
              {product.images360?.length > 0 && (
                ...
                >
                  ...
                  <span className="mt-1">360 View</span>
                </button>
              )}
            </div>
            ...
            <div>
              ...
              <p className="text-[22px] my-3 text-black ">₹ {product.price}</p>
              ...
              <div className="flex items-center gap-4 mt-3">
                ...
                <span className="text-[13px] text-gray-500">(93 Reviews)</span>
              </div>
              ...
              <div className="flex gap-4 mt-7">
                <a
                  ...
                  className="bg-[#ff5a00] hover:bg-[#f04f00] transition-all text-white h-[54px] px-8 rounded-xl font-semibold flex items-center gap-3"
                >
                ...
                <Link
                  href={`https://wa.me/+917669988825?text=Hi, I have seen your product on https://packingairbag.com and I am interested in ${product.name}`}
                  target="_blank"
                  className="bg-[#038b31] hover:bg-[#027528] transition-all text-white h-[54px] px-8 rounded-xl font-semibold flex items-center gap-3"
                >
              ...
              <div className="space-y-2">
                {product.specs?.map((spec, index) => (
                  <div key={index} className="text-[15px] text-[#4a4a4a]">
              ...
              <div className="flex items-center gap-4 mt-5">
                <span className="font-semibold text-[15px]">Visit Us:</span>
            ...
            <div className="bg-[#efefef] border border-[#dddddd] rounded-2xl px-3 p-1 h-fit">
              <h3 className="text-[32px] font-bold text-[#f04200]">DPACK</h3>
              ...
              <h4 className="font-bold text-[20px] mb-3">Why Choose DPACK</h4>
              ...
              <h4 className="font-bold text-[20px] mt-5 mb-4">About DPACK</h4>
