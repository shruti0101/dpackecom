  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-black/80 text-sm md:text-base mb-10">
          Discover premium dunnage bags and protective packaging solutions
          designed for safety, durability, and performance.
        </p>

        <a target="black" href="tel:+919876543210" className="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition text-sm md:text-base font-medium">
          Get Started →
        </a>
      </div>
    </section>
